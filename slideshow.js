...
function createRollover(thumb) {
	...
	//replaces the _thumb from the slide filename with _over
...
function createGallery(slides) {
	...
	//paragraph containing the close button
	...
	//appends the button to the paragraph and the paragraph to gallery
...
//creates an image object containing the high-resolution version of the thumbnail
...
function showGallery() {
	...
	changeSlide(this);//the this keyword references the thumbnail clicked by the user
...
function changeSlide(slide) {
	...
	//creates an object reference to the <span> tag containing the number of the current slide
	...
	//changes the index value to reflect the new slide in the gallery
	...
	//changes the slide number to match the currently displayed slide
